...
- (void)viewDidLoad
{
    ...
    _tabBarFrame = CGRectMake(0, self.view.height - TabBar_Height, self.view.width, TabBar_Height);
    _contentFrame = CGRectMake(0, 0, self.view.width, self.view.height - TabBar_Height);
...
- (void)loadContentViews
{
    ...
    _tabBar.frame = CGRectMake(0, self.view.height - TabBar_Height, self.view.width, TabBar_Height);
    _contentView.frame = CGRectMake(0, 0, self.view.width, self.view.height - TabBar_Height);
